...
DSMGA2::DSMGA2 (int n_ell, int n_nInitial, int n_maxGen, int n_maxFe, std::function<double(const Chromosome&)> customFn) {
    ...
    Chromosome::function = Chromosome::CUSTOM;
    Chromosome::customFunction = customFn;
    Chromosome::nfe = 0;
    Chromosome::lsnfe = 0;
    Chromosome::hitnfe = 0;
